...
rm(list=ls())
test_username <- "ykl17" # this should be your username
year <- 2020
...
load_student_work <- function(student_username) {
  ...
  if(file_test("-f",student_file)) {
    ...
    load_test_data[[length(load_test_data)+1]] <-  test_data_updated(name,"name","Billy Lam")
    load_test_data[[length(load_test_data)+1]] <-  test_data_updated(preferred_name,"preferred_name","Billy")
    load_test_data[[length(load_test_data)+1]] <-  test_data_updated(email,"email","yu.lam17@imperial.ac.uk")
    load_test_data[[length(load_test_data)+1]] <-  test_data_correct(username,"ykl17",test_username)
  } else {
